...
figure_path = r'/inputs/garbage-v2/data/test'  # 图片的位置
figure_name_label = r'D:\Program_self\basicTorch\inputs\garbage-v2\data\ann_test.txt'  # 保存图片名称和标签
batch_save = r'D:\Program_self\basicTorch\inputs\garbage-v2\cifar_alike'  # 保存batch文件
